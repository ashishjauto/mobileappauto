...
public class AppiumAndroidCalculator {
    ...
    public void Sum() throws InterruptedException, MalformedURLException {
        ...
        UiAutomator2Options options = new UiAutomator2Options()
                ...
                .setAppPackage("com.sec.android.app.camera")  // change based on your device
                .setAppActivity("com.sec.android.app.camera.Camera")
                .setAppWaitForLaunch(true)
                .autoGrantPermissions();// change as needed
                   // Don't reset camera state

        AndroidDriver driver = new AndroidDriver(new URL("http://192.168.1.6:4723/wd/hub"), options);

        Thread.sleep(15000); // Wait for camera to load
